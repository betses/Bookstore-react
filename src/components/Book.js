...
function Book(props) {
  ...
  return (
    <>
      {mapData.map((i) => (
        <div key={i.id} className="flex justify-between border border-#94a3b8 m-10 sm:mx-20 sm:my-10 p-6 bg-white">
          <div className="flex flex-col gap-7">
            ...
            <button type="button" className="text-base bg-blue-800 text-white py-2 sm:text-sky-600 sm:bg-transparent sm:w-1/12 sm:text-left" onClick={() => removeNow(i)}>Remove</button>
          </div>
